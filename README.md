...
- **Rich previews and thumbnails:** bounded previews for text, source code, images, camera RAW, PDF, audio, and video, with native parser-backed formats isolated from the application. Properties and the preview pane show available media resolution, duration, bitrate, codecs, and audio/video rates.
